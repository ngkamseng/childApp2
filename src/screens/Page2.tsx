...
const Page2 = () => {
  const counter = useAppSelector(state => state.ChildApp2_transaction.counter)
  const {userId, token } = useAppSelector(state => state.ChildApp2_login)
      ...
      <SafeAreaView>
        <ScrollView contentInsetAdjustmentBehavior="automatic">
          <View style={commonStyles.container}>
            <View>
              <Text style={commonStyles.titles}>ChildApp2 Page 2</Text>
            </View>
