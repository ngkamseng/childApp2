        ...
        <SafeAreaView>
          <ScrollView contentInsetAdjustmentBehavior="automatic">
            ...
            <View style={commonStyles.container}>
              <View>
                <Text style={commonStyles.titles}>ChildApp2 Home Page</Text>
              </View>
...
const mapStateToProps = (state:RootState) => {
  const { counter, transactionId } = state.ChildApp2_transaction
